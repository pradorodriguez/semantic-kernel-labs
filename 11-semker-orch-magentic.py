...
# Guide: https://learn.microsoft.com/en-us/semantic-kernel/frameworks/agent/agent-orchestration/magentic?pivots=programming-language-python
# Code Repo: https://github.com/microsoft/semantic-kernel/blob/main/python/samples/getting_started_with_agents/multi_agent_orchestration/step5_magentic.py
...
- A Research agent that can perform web searches  with the gpt-4o-search-preview model.
...
async def agents() -> list[Agent]:
    ...
    # OpenAIAssistantAgent automatically reads env variab

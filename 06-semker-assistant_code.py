...
async def main():
    ...
    # AzureAssistantAgent Class: https://learn.microsoft.com/en-us/python/api/semantic-kernel/semantic_kernel.agents.open_ai.azure_assistant_agent.azureassistantagent?view=semantic-kernel-python
    client, model = AzureAssistantAgent.setup_resources(
        endpoint=azopenai_ep,
        api_key=azopenai_key,
        deployment_name=azopenai_model,
        api_version=azopenai_api_ver    
    )   
    ...
    # Get the code interpreter tool and resources: Generate the tool + resources needed to enable the "code_interpreter" functionality.
    # https://learn.microsoft.com/en-us/python/api/semantic-kernel/semantic_kernel.agents.open_ai.open_ai_assistant_agent.openaiassistantagent?view=semantic-kernel-python#semantic-kernel-agents-open-ai-open-ai-assistant-agent-openaiassistantagent-configure-code-interpreter-tool
